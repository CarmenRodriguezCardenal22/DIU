...
public class Botones extends Application {
    ...
    public void start(Stage escenarioPrincipal) {
        try {
            ...
            Image imagen = new Image("file:resources/imagenes/encender.jpeg", 50, 50, true, true);
            btTextoImagen.setGraphic(new ImageView(imagen));
            btTextoImagen.setText("Encender");
            btTextoImagen.setGraphicTextGap(20);
            btTextoImagen.setFont(Font.font("Ani", 20));

            imagen = new Image("file:resources/imagenes/apagar.jpeg", 60, 60, true, true);
