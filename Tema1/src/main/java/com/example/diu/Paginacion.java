...
public class Paginacion extends Application {
    ...
    private VBox creaPagina(int indice) {
        ...
        if (indice == 0) {
            Image logo1 = new Image("file:resources/imagenes/logo1.jpg", 200, 300, true, true);
            raizPagina.getChildren().add(new ImageView(logo1));
            return raizPagina;
        } else if (indice == 1) {
            Image logo2 = new Image("file:resources/imagenes/logo2.jpg", 350, 200, true, true);
            raizPagina.getChildren().add(new ImageView(logo2));
            return raizPagina;
        } else
            return null;
    }
