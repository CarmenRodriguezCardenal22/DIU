...
public class InformacionContextual extends Application {
    ...
    public void start(Stage escenarioPrincipal) {
        try {
            ...
            Image imagenEnc = new Image("file:resources/imagenes/encender.jpeg", 50, 50, true, true);
            btBeber.setGraphic(new ImageView(imagenEnc));
            ...
            Image imagenApagar = new Image("file:resources/imagenes/apagar.jpeg", 50, 50, true, true);
            infoCerveza.setGraphic(new ImageView(imagenApagar));
